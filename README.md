...
2. **Neuroscience mapping**: Used Meta FAIR's TRIBE v2 brain encoder (https://arxiv.org/abs/2507.22229) to predict how different design stimuli activate the brain. TRIBE v2 takes in video, audio, or text and outputs predicted fMRI activation across the entire cortex. We fed it different design variations (nature imagery vs. clinical layouts, warm palettes vs. harsh ones, soundscapes vs. silence) and compared the predicted brain responses. From those comparisons, we derived six design principles.
